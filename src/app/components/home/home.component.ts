...
import { HomeSliderComponent } from 'src/app/userLayout/components/home-slider/home-slider.component';
...
@Component({
    ...
    imports: [FeaturedProductComponent, MostPopularComponent, HomeProductComponent,HomeSliderComponent]
})
